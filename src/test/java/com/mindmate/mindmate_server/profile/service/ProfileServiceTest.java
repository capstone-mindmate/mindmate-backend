...
class ProfileServiceTest {
    ...
    @Mock private ProfileImage mockProfileImage;
    ...
    void setUp() {
        ...
        when(mockProfileImage.getImageUrl()).thenReturn("http://example.com/image.jpg");
        ...
        when(profileImageService.getDefaultProfileImage()).thenReturn(mockProfileImage);
    }
    ...
    void getProfileDetail() {
        ...
        assertEquals(mockProfileImage.getImageUrl(), response.getProfileImage());
    ...
    void createProfile() {
        ...
        when(profileImageService.findProfileImageById(1L)).thenReturn(mockProfileImage);
        ...
        verify(pointService).addPoints(eq(userId), any());
    }
    ...
    void updateProfile() {
        ...
        ProfileImage newProfileImage = mock(ProfileImage.class);
        when(profileImageService.findProfileImageById(2L)).thenReturn(newProfileImage);
        ...
        verify(mockProfile).updateProfileImage(newProfileImage);
