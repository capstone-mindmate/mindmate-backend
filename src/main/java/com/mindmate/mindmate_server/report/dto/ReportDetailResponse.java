...
public class ReportDetailResponse {
    ...
    public static ReportDetailResponse from(Report report) {
        ...
        return ReportDetailResponse.builder()
                ...
                .reporterImage(reporterProfile != null ? reporterProfile.getProfileImage() : null)
                ...
                .reportedUserImage(reportedUserProfile != null ? reportedUserProfile.getProfileImage() : null)
